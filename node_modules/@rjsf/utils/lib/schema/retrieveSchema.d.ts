import type { Experimental_CustomMergeAllOf, FormContextType, RJSFSchema, StrictRJSFSchema, ValidatorType } from '../types.js';
 ...
 */
export declare function relaxOptionsForScoring<S extends StrictRJSFSchema = RJSFSchema>(options: (S | boolean)[], resolveRefs?: boolean, rootSchema?: S): S[];
